...
data = np.loadtxt(input_file, delimiter=',')   #delimiter is string to seperate values and 1st field is input file 

# Arrange data for training 
X = np.column_stack([data[:,2]])       #stack  1d arrays as columns in 2d array
