...
# Load data
data1 = convert_data_to_timeseries(input_file, 2)    ####column 2 is called the 'first' 
data2 = convert_data_to_timeseries(input_file, 3)    ####and column 3 is called the 'second' 
